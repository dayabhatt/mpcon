                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <textarea class="form-control" id="key_responsibilities_supporting_staff" name="key_responsibilities_supporting_staff" rows="2">{{old('key_responsibilities_supporting_staff')}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <textarea class="form-control" id="areas_of_interest_supporting_staff" name="areas_of_interest_supporting_staff" rows="2">{{old('areas_of_interest_supporting_staff')}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    <label for="project_reports_consultancy" class="">A.3	Please indicate the areas /subject on which you would like to undergo training in the
                                        future.</label>
                                    <textarea class="form-control" id="undergo_training_supporting_staff" name="undergo_training_supporting_staff" rows="2">{{old('undergo_training_supporting_staff')}}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <textarea class="form-control" id="other_comment_ss" name="other_comment_ss" rows="2">{{old('other_comment_ss')}}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <textarea class="form-control" id="suggestions_md_ss" name="suggestions_md_ss" rows="2">{{old('suggestions_md_ss')}}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <textarea class="form-control" id="key_responsibilities_supporting_staff_last" name="key_responsibilities_supporting_staff_last" rows="2">{{old('key_responsibilities_supporting_staff_last')}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    <label for="filled_reporting_officer" class="">B. To be filled by the Reporting Officer/Admn. Incharge</label>
                                    <textarea class="form-control" id="filled_reporting_officer" name="filled_reporting_officer" rows="2">{{old('filled_reporting_officer')}}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <textarea class="form-control" id="comment_rofficer" name="comment_rofficer" rows="2">{{old('comment_rofficer')}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    <label for="filled_reporting_officer" class="">C.1 Please indicate the areas on  which the appraise needs improvement </label>
                                    <textarea class="form-control" id="needs_improvement" name="needs_improvement" rows="2">{{old('needs_improvement')}}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-2">
                                    ...
                                    <textarea class="form-control" id="md_suggestion" name="md_suggestion" rows="2">{{old('md_suggestion')}}</textarea>
                                </div>
                            </div>
